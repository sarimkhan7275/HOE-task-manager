...
export const TaskColumn = ({ data, status }: { data: Task[]; status: string }) => {
  ...
  return (
    <div className="min-w-[300px] flex flex-col rounded-xl bg-zinc-900 border border-border w-full shadow-sm">
      {/* Header */}
      <div className="flex items-center justify-between p-4 border-b border-border sticky top-0 bg-zinc-900 z-10">
      ...
      <div className="p-4 border-t border-border bg-zinc-900 sticky bottom-0">
        <Button
          onClick={() => setIsOpen(true)}
          className="w-full flex items-center gap-2 rounded-lg bg-gradient-to-r from-indigo-500 to-purple-500 text-white font-medium shadow-md hover:opacity-90 transition"
        >
